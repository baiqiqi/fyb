...
/**
 * XiuFile represents the information for an uploaded file.
 *
...
class XiuFile extends Object
{
     ...
     * @return XiuFile the instance of the uploaded file.
     ...
     * @return XiuFile[] array of XiuFile objects.
     ...
     * @return XiuFile[] the array of XiuFile objects. Empty array is returned
    ...
    /**
     * Cleans up the loaded XiuFile instances.
    ...
    /**
     * Creates XiuFile instances from $_FILE.
     * @return array the XiuFile instances
     */
    ...
    /**
     * Creates XiuFile instances from $_FILE recursively.
