        ...
        <script language="javascript" type="text/javascript">
            ...
            function goods_add(){
                ...
                num_val.value=Num;
                            ...
                            <p>
                                <a href="./index.php?r=check/pay"><input class="pointer add_pay" type="button" name="now_buy" id="now_buy" value="立即购买" onclick="addToCart(371,0,1)" style="background-color: rgb(255, 237, 237); color: rgb(196, 0, 0); border: 1px solid rgb(196, 0, 0); width: 170px; font-family: microsoft yahei; font-size: 16px;"/></a>
