...
/**************************请求参数**************************/
        ...
        //页面跳转同步通知页面路径  --->客户
        $return_url = "http://www.com133.com/return_url.php";
...
echo  $html_text;   //---->自动跳转到https://mapi.alipay.com/gateway.do?_input_charset=utf-8这个地址
