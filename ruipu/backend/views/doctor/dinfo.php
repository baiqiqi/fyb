...
<tr id="operation"><td colspan="9" ><input type="button" value="全选" onclick="allSelectType();"/><input type="button" value="反选" onclick="invertSelectType();"/><input type="button" value="批量删除" onclick="invertSelectType();"/>
</td></tr>
</table>
</center>
</div>
