                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
							...
							<td>
								<a class="link-update" href="index.php?r=userinfo/save&id=<?php echo $v['u_id']?>">修改</a>
								<a class="link-del" onclick="if(confirm('确定删除？')) return true; else return false;" href="index.php?r=userinfo/delete&id=<?php echo $v['u_id']?>" class='outiong'>移除</a>
							</td>

                        </tr>
                         <?php } ?>
                    </table>
                        <center><a href="index.php?r=userinfo/info&page=<?php 
                        if ($page-1<1) {
                            echo '1';
                        }else{
                            $aa = $page-1;
                        ...
                        <a href="index.php?r=userinfo/info&page=<?php 
                        if ($page+1>$countpage) {
                            echo "$countpage";
                        }else{
                            $bb = $page+1;
